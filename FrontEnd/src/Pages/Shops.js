...
export default function Shops() {
    ...
    useEffect(async () => {
       db.collection("MerchantList").onSnapshot((snapshot) => {
        ...
        var late=localStorage.getItem('lat')===undefined?17.453480156666696:parseFloat(localStorage.getItem('lat'));
        var long= localStorage.getItem('long')===undefined?78.52981425632895:parseFloat(localStorage.getItem('long'));
        useEffect(() => {
            late = localStorage.getItem('lat')===undefined?17.453480156666696:parseFloat(localStorage.getItem('lat'));
            long = localStorage.getItem('long')===undefined?78.52981425632895:parseFloat(localStorage.getItem('long'));
        }, [])
        return (<div className="home">
            ...
            <div className='row'><div><div style={{ height: "calc(100vh - 200px)", width: "100%" }}>
                <GoogleMapReact
                    ...
                    defaultCenter={{ lat:late , lng: long }}
                    defaultZoom={14}
